...
#define LV_TICK_CUSTOM 1
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "SDL2/SDL_timer.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR ((uint32_t)SDL_GetTicks())    /*Expression evaluating to current system time in ms*/
